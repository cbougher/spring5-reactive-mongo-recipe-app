...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.debug("Found " + recipeReactiveRepository.count().block().toString() + " Recipes");
        log.debug("Found " + categoryReactiveRepository.count().block().toString() + " Categories");
        log.debug("Found " + unitOfMeasureReactiveRepository.count().block().toString() + " UOMs");
    }
